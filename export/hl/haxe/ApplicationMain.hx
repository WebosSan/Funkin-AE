...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Funkin AE", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Funkin AE", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Funkin AE";
		app.meta["name"] = "Funkin AE";
